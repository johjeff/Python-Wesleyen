...
def problem1_4(miles):
    len_ = miles * 5280
    print("There are",len_,"feet in",miles,"miles.")# replace this pass (a do-nothing) statement with your code
...
def problem1_5(age):
    if age < 7:
        ...
        print("Have a coke.")# replace this pass (a do-nothing) statement with your code
...
def problem1_6():
    for ct in range(1,100,2):
        print(ct,end=" ")# replace this pass (a do-nothing) statement with your code
...
#%%
def problem1_7():
    l1 = input("Enter the length of one of the bases: ")
    l2 = input("Enter the lentch of the other base: ")
